(function () {
    ...
    var quiz_json_el = document.getElementById("quiz_json");
    var jsonString = quiz_json_el.value; //'<%= _quiz %>';// {{_quiz}};
    ...
    if (check_quiz()) {
        ...
        function send_results() {
            ...
            var send_result = document.getElementById('quiz_result');
            //let a = spent_time[0]
            var percentage;
            var whole_time = 0;
            ...
            console.log(spent_time_1);
            console.log(percentage);
            percentage = new Array(quiz.questions.length);
            for (var i = 0; i < percentage.length; i++) {
                percentage[i] = round(spent_time_1[i] * 100 / whole_time);
            }
            var result_json = { jsonString: jsonString, answers: answers_1, percentage: percentage };
