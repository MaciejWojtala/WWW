...
function start_quiz(_driver) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (_driver.findElement(selenium_webdriver_1.By.name('quiz'))).click()];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, _driver.findElement(selenium_webdriver_1.By.id('odpowiedź ' + i.toString()))];
                case 2: return [4 /*yield*/, (_a.sent()).sendKeys('0')];
                case 3:
                    _a.sent();
...
function finish_quiz(_driver) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, _driver.findElement(selenium_webdriver_1.By.id('zakończ_quiz'))];
