        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        driver_2 = _a.sent();
                        return [4 /*yield*/, test_1.login(driver_1)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, test_1.login(driver_2)];
                    case 5:
                        _a.sent();
                        return [4 /*yield*/, driver_1.findElement(selenium_webdriver_1.By.name('change_password'))];
                    case 6: return [4 /*yield*/, (_a.sent()).click()];
                    case 7:
                        _a.sent();
                    ...
                    case 10: return [4 /*yield*/, (_a.sent()).click()];
                    case 11:
                        _a.sent();
                    ...
                    case 13: return [4 /*yield*/, (_a.sent()).click()];
                    case 14:
                        _a.sent();
                        return [4 /*yield*/, driver_1.findElement(selenium_webdriver_1.By.name('password'))];
                    case 15:
