...
var DbClass = /** @class */ (function () {
    ...
    DbClass.prototype.open_with_transaction = function () {
    ...
    DbClass.prototype.commit_close = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
    ...
    DbClass.prototype.rollback_close = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.run(sql, ['user1', password_hash_1["default"].generate('user1'), 'user2', password_hash_1["default"].generate('user2')])];
                    case 3:
                        _a.sent();
